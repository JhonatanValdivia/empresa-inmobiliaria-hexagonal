...
@Embeddable
public class ZonificacionInfr {

    private String tipoZona;
    private String descripcionNormativa;
    private String usoPermitido;

    public ZonificacionInfr() {}

    public ZonificacionInfr(String tipoZona, String descripcionNormativa, String usoPermitido) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ZonificacionInfr)) return false;
        ZonificacionInfr other = (ZonificacionInfr) obj;
